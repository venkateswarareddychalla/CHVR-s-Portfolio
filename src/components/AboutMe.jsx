...
const AboutMe = () => {
  return (
    <section id="about" className="py-24 px-4 relative">
      <div className="container mx-auto nax-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              As a Full Stack Developer, I build seamless and scalable web
              solutions using ReactJS, Node.js, SQL, and MongoDB & creating
              user-centric applications that are both performant and impactful.
            </p>
            <p className="text-muted-foreground">
